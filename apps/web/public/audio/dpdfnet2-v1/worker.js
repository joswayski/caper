import * as ort from '../dpdfnet8-v2/ort.wasm.bundle.min.mjs';
import { DpdfnetStream } from '../dpdfnet8-v2/dsp.js';

ort.env.wasm.numThreads = 1;
ort.env.wasm.wasmPaths = new URL('../dpdfnet8-v2/', import.meta.url).href;
